	...
	<view>
		...
		<view class="watermarks">
			<block v-for="(t, i) in count" :key="'concise'+i">
				<!--简洁样式，只有一行-->
				<view class="concise">
					<image src="../../static/kxj-watermark/logo1.png" style="width:26rpx;height: 26rpx;float: left;"></image>
...
.watermarks {
	position: fixed;
	z-index: 996;//h5版本是不覆盖标题栏，标题栏z-index=998
	display: flex;
	flex-wrap: wrap;
	pointer-events: none;
	width: 150%;//为了整个屏幕都扑满水印采取的取巧的操作
	height: 120%;//为了整个屏幕都扑满水印采取的取巧的操作
	top: 0;
	bottom: 0;
	left: 0;
	right: 0;
